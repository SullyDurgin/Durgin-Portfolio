		...
		<section id='contact' className='relative'>
			<div className='container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'>
					...
					<div className='bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md'>
						<div className='lg:w-1/2 px-6 mt-4 lg:mt-0'>
							...
							<a className='text-indigo-400 leading-relaxed'>
								katsdurgin@gmail.com
							</a>
							<h2 className='title-font font-semibold text-white text-xs mt-4'>
								PHONE
							</h2>
							<p className='title-font font-semibold text-white text-xs mt-4'>
								339-235-3425
							</p>
						</div>
					</div>
				...
				<form
					...
					className='lg:w-3/4 md:w-3/4 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0'>
